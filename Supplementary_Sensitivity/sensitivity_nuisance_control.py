...
Purpose
-------
Addresses Reviewer 2, Q5(c): "examining whether similar IMC patterns could
arise when other model parameters are varied might help clarify whether the
observed effects are specific to neural crosstalk."
